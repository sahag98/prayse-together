...
const ProfilePage = () => {
  ...
  const badges = [
    {
      ...
      achieved: studiedPlans.length === 1,
    },
  ...
  return (
    <SafeAreaView edges={['top']} className="w-full flex-1 bg-background p-5">
        ...
        <View className="h-full w-full flex-1 gap-5">
          ...
          {/* <View className="mt-4 w-full gap-3">
            <View className="flex-row items-center justify-center gap-3">
              <Text className="text-lg font-medium text-foreground">Achievements</Text>
            ...
            <View className="flex-row gap-3">
              {badges.map((badge, index) => (
                <View
                  ...
                  />
                  <Text className="text-xs font-medium">{badge.title}</Text>
                </View>
              ))}
            </View>
          </View> */}
          ...
          <View className="justify-center gap-1 rounded-2xl border  border-cardborder bg-card p-4">
            <Text className="text-center font-nunito-semibold text-foreground">
              App Theme Verse
            </Text>
